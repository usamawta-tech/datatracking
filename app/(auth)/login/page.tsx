...
export const metadata = { title: "Sign in — AI Tracker" };
      ...
      <div className="hidden lg:flex lg:w-[420px] bg-slate-900 flex-col justify-between p-10 shrink-0">
        ...
        <div>
          <p className="text-2xl font-bold text-white leading-snug mb-4">
            Your funnel tags,<br />deployed automatically.
          </p>
          <div className="space-y-3">
            {[
              "Connect GTM in one click",
              "Build multi-page funnels visually",
              "AI creates all tags — no manual work",
              "Mixpanel events fire automatically",
            ].map((item) => (
