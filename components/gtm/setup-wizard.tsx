  ...
  return (
    <div className="relative">
      <select
        ...
        disabled={ld}
        className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm bg-white text-gray-900 [&>option]:bg-white [&>option]:text-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 disabled:opacity-60 appearance-none pr-8"
      >
        {children}
      </select>
